#!/usr/bin/env python3
# Re-validation of the PR #5301 OOM-guard classifier at head 284145a7
...
# ── verbatim from worker.py:2291-2295 @ 284145a7 ──
...
print()
print(f"classifier @ 284145a7      : _is_unified={_is_unified}  -> fraction={_mem_fraction}")
...
if _is_unified and _mem_fraction == 0.80:
    ...
    print("        284145a7's gcnArchName check returns the correct value.")
else:
